...
public class GildedRoseTest {
	...
	public void updateQuality() {
		...
		bestQualityItem = new AgedBrieItem(0, 50);

		plusFiveDextryVest = new Item("+5 Dexterity Vest", 10, 20);
		elixirOfTheMongoose = new Item("Elixir of the Mongoose", 5, 7);

		agedBrie = new AgedBrieItem(2, 0);

		sulfurasSellin0 = new SulfurasItem(0, 80);
		sulfurasSellinMinus1 = new SulfurasItem(-1, 80);

		backstagPasses1 = new BackstageItem(15, 20);
		backstagePasses2 = new BackstageItem(10, 49);
		backstagePasses3 = new BackstageItem(5, 49);

		conjured = new ConjuredItem(5, 7);

		GildedRose app = new GildedRose(Arrays.asList(foo, worstQualityItem, bestQualityItem, plusFiveDextryVest,
				elixirOfTheMongoose, agedBrie, sulfurasSellin0, sulfurasSellinMinus1, backstagPasses1, backstagePasses2,
				backstagePasses3, conjured));
